...
<ContenedorSecundario>
	<Titulo tituloPrincipal="Reporte Candidatos" />
	<Datatable {settings} bind:data class="tablaInfo">
		<thead>
			<th data-key="idUsuarios">ID</th>
			<th data-key="nombre">NOMBRE CANDIDATO</th>
		...
		<tbody>
			{#each $rows as row}
				<tr>
					...
					<td class="flex inline-block justify-center"><Ver titulo="VER CANDIDATO" cuerpo="reportecandidato"/> <i class="bi bi-printer p-3"></i><i class="bi bi-cloud-download p-3"></i></td>
