<div class="flex flex-wrap -mx-3 mb-6">
	<div class="w-full md:w-1/2 px-3 mb-10 md:mb-0 mt-10">
	...
	<div class="flex justify-end mt-3 w-full md:w-1/1 px-3 mb-10 md:mb-0">
		<button
	...
	<div class="w-full md:w-1/3 px-3 mb-10 md:mb-0 mt-10">
    ...
    <div class="w-full md:w-1/3 px-3 mb-10 md:mb-0 mt-10 content-center ">
		<button
			class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none"
		>
			<span class="ml-4 flex items-start flex-col leading-none">
				<span class="text-xs text-gray-600 mb-1">Quitar</span>
			</span>
		</button>
	</div>
</div>
